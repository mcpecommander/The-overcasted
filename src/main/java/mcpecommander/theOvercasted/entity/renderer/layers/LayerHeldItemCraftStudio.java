...
public class LayerHeldItemCraftStudio implements LayerRenderer<EntityLivingBase>
{
    protected final RenderLivingBase<?> livingEntityRenderer;

    public LayerHeldItemCraftStudio(RenderLivingBase<?> livingEntityRendererIn)
    {
	...
	private void renderHeldItem(EntityLivingBase entity, ItemStack heldItemStack,
		...
		if (!heldItemStack.isEmpty()) {
			...
			if (flag) {
				...
				GlStateManager.translate(0, -0.2, -0.36F);
			} else {
    ...
    protected void translateToHand()
	{
		...
		if (((CraftStudioModelSon) this.livingEntityRenderer.getMainModel())
			...
			RightArm1 = ((CraftStudioModelSon) this.livingEntityRenderer.getMainModel())
    ...
    protected void translateToLeftHand()
    {
		...
		if (((CraftStudioModelSon) this.livingEntityRenderer.getMainModel())
			...
			LeftArm1 = ((CraftStudioModelSon) this.livingEntityRenderer.getMainModel())
