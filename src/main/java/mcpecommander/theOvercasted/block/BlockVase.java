...
public class BlockVase extends Block implements IHasModel{
	
	public BlockVase() {
		super(Material.ROCK, MapColor.GRAY_STAINED_HARDENED_CLAY);
		setRegistryName(Reference.ModBlocks.VASE.getRegistryName());
		setUnlocalizedName(Reference.ModBlocks.VASE.getName());
	...
	public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
		return new AxisAlignedBB(3d/16d, 0d, 3d/16d, 13d/16d, 13d/16d, 13d/16d);
	}
