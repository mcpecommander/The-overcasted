...
public class BlockMushroomSprout extends Block implements ITileEntityProvider {
	...
	public BlockMushroomSprout() {
		...
		this.setRegistryName(Reference.ModBlocks.MUSHROOMSPROUT.getRegistryName())
				...
				.setCreativeTab(TheOvercasted.overcastedTab).setHardness(0.5f).setLightOpacity(1).setResistance(0f);
	...
	public void onBlockAdded(World world, BlockPos pos, IBlockState state) {
		world.setBlockState(pos,
				state.withProperty(FACING, EnumFacing.HORIZONTALS[world.rand.nextInt(EnumFacing.HORIZONTALS.length)]),
				2);
	}
	...
	public boolean canPlaceBlockAt(World worldIn, BlockPos pos) {
		...
		if (flag && (worldIn.getBlockState(pos.down()) == Blocks.MYCELIUM.getDefaultState()
				|| worldIn.getBlockState(pos.down()) == Blocks.GRASS.getDefaultState())) {
			return true;
		}
		return false;
	}
